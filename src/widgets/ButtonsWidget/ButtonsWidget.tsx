    ...
    return(
        <Container fluid className='bg-transparent'>
            <Row className='align-items-top'>
                <Col xl='2' lg='3' md='3' sm='2'/*style={{border:'2px solid'}}*/>{/*space*/}</Col>
                <Col xl='4' lg='6' md='6' sm='8' className='text-center' /*style={{border:'2px solid',color:'red',justifyContent:'center'}}*/>
                ...
                <Col xl='1' /*style={{border:'2px solid'}}*/>{/*space*/}</Col>
                <Col xl='3' lg='12' md='12' sm='12' className='text-center h-100 d-lg' /*style={{border:'2px solid'}}*/>
                    {(currentDescId==0) && <div className='bg-white p-3 m-2 shadow' style={{borderRadius:'10px'}}>{props.texts.at(0)}</div>}

                    {(currentDescId==1) && <div className='bg-white p-3 m-2 shadow' style={{borderRadius:'10px'}}>{props.texts.at(1)}</div>}
                    {(currentDescId==2) && <div className='bg-white p-3 m-2 shadow' style={{borderRadius:'10px'}}>{props.texts.at(2)}</div>}
                    {(currentDescId==3) && <div className='bg-white p-3 m-2 shadow' style={{borderRadius:'10px'}}>{props.texts.at(3)}</div>}

                    {(currentDescId==4) && <div className='bg-white p-3 m-2 shadow' style={{borderRadius:'10px'}}>{props.texts.at(4)}</div>}
                    {(currentDescId==5) && <div className='bg-white p-3 m-2 shadow' style={{borderRadius:'10px'}}>{props.texts.at(5)}</div>}
                    {(currentDescId==6) && <div className='bg-white p-3 m-2 shadow' style={{borderRadius:'10px'}}>{props.texts.at(6)}</div>}
                    
                    {(currentDescId==7) && <div className='bg-white p-3 m-2 shadow' style={{borderRadius:'10px'}}>{props.texts.at(7)}</div>}
                    {(currentDescId==8) && <div className='bg-white p-3 m-2 shadow' style={{borderRadius:'10px'}}>{props.texts.at(8)}</div>}
                    {(currentDescId==9) && <div className='bg-white p-3 m-2 shadow' style={{borderRadius:'10px'}}>{props.texts.at(9)}</div>}
                </Col>
            </Row>
